...
namespace SitefinityWebApp.Mvc.Models.TestimonialList
{
    ...
    public class TestimonialListModel
    {
        ...
        public TestimonialListViewModel GetViewModel()
        {
            return new TestimonialListViewModel()
            {
        ...
        protected virtual Testimonial GetTestimonial()
        {
