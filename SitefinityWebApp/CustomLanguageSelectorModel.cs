...
{
    public class CustomLanguageSelectorModel : ILanguageSelectorModel
    {
            ...
            public LanguageSelectorViewModel CreateViewModel()
            {
                ...
                IEnumerable<CultureInfo> shownLanguages = this.GetLanguagesToDisplay();
                 ...
                 CultureInfo culture_enUS = CultureInfo.GetCultureInfo("en-US");
                CultureInfo culture_en = CultureInfo.GetCultureInfo("en");
            ...
            foreach (var lang in shownLanguages)
                ...
                //redirects of the missing translations to respective language ( South America to go to - North America ) and Others to go to Asia-Pacific and change of display name
                ...
                {
                    case "English":
                        langName = "Asia-Pacific";
                        break;
                    case "English (United States)":
                        langName = "North America";
                        break;
                    case "English (American Samoa)":
                        langName = "South America";


                        url = this.GetUrlForLanguage(culture_enUS);
                    ...
                    case "English (Europe)":
                        ...
                        url = this.GetUrlForLanguage(culture_en);
                        url = RouteHelper.ResolveUrl(url, UrlResolveOptions.Absolute);
                        break;
